...
public class InventoryStockController {
    ...
    public ResponseEntity<APIResponse<InventoryStockResponseDTO>> getById(@PathVariable UUID inventoryId) {

        InventoryStockResponseDTO response = inventoryStockService.getById(inventoryId);
        return ResponseEntity.ok(APIResponse.<InventoryStockResponseDTO>builder()
            .data(response)
    ...
    public ResponseEntity<APIResponse<AvailabilityResponseDTO>> availability(
        ...
        AvailabilityResponseDTO response = inventoryStockService.availability(
            variantId,
            locationCode);

        return ResponseEntity.ok(APIResponse.<AvailabilityResponseDTO>builder()
            .data(response)
    ...
    public ResponseEntity<APIResponse<InventoryStockResponseDTO>> create(
        ...
        InventoryStockResponseDTO response = inventoryStockService.create(request);
    ...
    public ResponseEntity<APIResponse<InventoryStockResponseDTO>> update(
        ...
        InventoryStockResponseDTO response = inventoryStockService.update(
            inventoryId,
            request
        );
        return ResponseEntity.ok(APIResponse.<InventoryStockResponseDTO>builder()
    ...
    public ResponseEntity<APIResponse<InventoryStockResponseDTO>> adjust(
        ...
        InventoryStockResponseDTO response = inventoryStockService.adjust(
            inventoryId,
            request
        );
        return ResponseEntity.ok(APIResponse.<InventoryStockResponseDTO>builder()
