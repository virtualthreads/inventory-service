...
public class InventoryMovementServiceImpl
    ...
    public void createMovement(
        ...
        log.debug(
                "Inventory movement created successfully: movementId={}",
                saved.getMovementId()
        );
    }
    ...
    public Page<InventoryMovementResponseDTO> getByVariant(
        ...
        log.debug(
                "Fetching inventory movements: variantId={}, page={}, size={}",
                productVariantId,
                pageable.getPageNumber(),
                pageable.getPageSize()
        );

        Page<InventoryMovementResponseDTO> movements =
                movementRepository
        ...
        log.debug(
                "Fetched {} inventory movements for variantId={}",
